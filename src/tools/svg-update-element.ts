...
export function registerSvgUpdateElement(
    ...
    server.registerTool(
        "svg_update_element",
        {
            description: "Update an existing element by ID. Change any attributes (fill, stroke, position, size, font-family, etc.). Set an attribute to empty string to remove it. Use svg_list_elements to find element IDs.",
            inputSchema: {
                id: z
                    .string()
                    .describe(
